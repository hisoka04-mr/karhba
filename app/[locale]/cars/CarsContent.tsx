...
export default function CarsContent({ cars }: { cars: any[] }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      {/* Page Header */}
      <div className="relative z-50 flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10 animate-fade-up">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          {/* Sort Dropdown */}
          <div className="relative flex-1 md:flex-none z-50">
            <button
